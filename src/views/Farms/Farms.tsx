  ...
  return (
    <Page>
      <Heading as="h1" size="lg" color="primary" mb="50px" style={{ textAlign: 'center' }}>
        {
          tokenMode ?
            TranslateString(10002, 'Stake tokens to earn PAMAN')
            :
          TranslateString(320, 'Stake LP tokens to earn PAMAN')
        }
      </Heading>
      ...
      <Image src="/images/paman/8.png" alt="illustration" width={1352} height={587} responsive />
    </Page>
  )
}
